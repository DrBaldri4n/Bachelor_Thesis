...
Kann ich hier einfach reinschreiben was ich will?
test testsetse ts ASDASgAS 
...
\subsection{Anomaly detection basics}

\subsection{Introduction to Decision Trees and feature importance}

\subsection{LSTM (Long Short-Term Memory) architecture overview}
...
% ----------------------------------------------------------------------------------
\section{Feature Selection Using Decision Tree}

\subsection{Rationale for feature selection with Decision Trees}

\subsection{Process of ranking and selecting the most important features from the original set}
...
\subsection{Building the LSTM model using only the selected features}
...
\pagebreak
% ----------------------------------------------------------------------------------
% Kapitel: Experimental Analysis
% ----------------------------------------------------------------------------------
%7.1 mit meinem LSTM kann ich auch die Angriffe wie im Datensatz
%7.2 LSTM archi auf uns anwenden
%7.3 visualisierung und vergleich von Öffentliche und Test umgebung

\section{Experimental Analysis}

\subsection{Experimental setup and evaluation metrics}

\subsection{Results of anomaly detection using the LSTM model}
