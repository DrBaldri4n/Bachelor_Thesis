...
% ----------------------------------------------------------------------------------
\include{content/chapter/7_LSTM_Structure/7.1_Structure_and_Functionality}
\input{content/chapter/7_LSTM_Structure/7.2_Training_and_validation}
\input{content/chapter/7_LSTM_Structure/7.3_Parameter Configuration}
