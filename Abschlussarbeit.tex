...
% ----------------------------------------------------------------------------------------------------------
\include{content/chapter/formular_stuff/list_of_tables}
...
\include{content/chapter/1_introduction/1.2_Challenges_in_securing}
\include{content/chapter/1_introduction/1.3_Overview_AI_approaches}
...
\include{content/chapter/2_Fundamentals/2.2_Introcution_ML_models}
\include{content/chapter/2_Fundamentals/2.3_Overview_of_LSTM}
...
https://arxiv.org/html/2401.01580v1 - Grafik von predicted und real values of charging situation of an EV


\pagebreak
% ----------------------------------------------------------------------------------
% Kapitel: Data Acquisition and Preprocessing 9
% ----------------------------------------------------------------------------------
...
\pagebreak
% ----------------------------------------------------------------------------------
% Kapitel: Design Methodology and LSTM Implementation 5
% ----------------------------------------------------------------------------------
